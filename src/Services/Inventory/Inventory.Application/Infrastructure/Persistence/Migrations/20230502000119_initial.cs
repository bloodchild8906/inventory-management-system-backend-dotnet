...
namespace Products.Application.Infrastructure.Persistence.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CompanyInfoLogo",
                schema: "Settings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompanyInfoId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Filename = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FileType = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyInfoLogo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyInfoLogo_CompanyInfo_CompanyInfoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RolePermissions_ModulePermissions_PermissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyInfoLogo_CompanyInfoId",
                schema: "Settings",
                table: "CompanyInfoLogo",
